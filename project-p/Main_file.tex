...
\label{fig:jomologo}
\end{figure}
   \large{testoneee and Technology}\\
   ...
   \large{Department of Marine Engineering and Maritime Operations}\\
    ...
    ------------------------------------------------------------------------------------------------\\[1.0cm]
    \LARGE{\textbf{Advanced Condition Based Predictive Maintenance of Electric Motors in Autonomous Ships}}\\[0.6cm]
    \LARGE{\textbf{Project Proposal (MR-PRO-21-011)
            }}\\[1.5cm]
    %\large{by}\\[0.6cm

    \vspace{0.5cm}
    \large{\textbf{Kirimi Nathan Mutuma~(ENM241-0190/2017)
            }}\\
     \large{\textbf{Kieran Kibichii~(ENM241-0127/2017)
            }}\\[1.0cm]
